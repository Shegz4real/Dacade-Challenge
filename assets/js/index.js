...
$('#regBtn').click(async function(){
  ...
  newProject = await contractCall('addProject', [Project_name, parseInt(Project_price, 10) , Project_images,Project_description, Project_link],parseInt(Project_price, 10));
